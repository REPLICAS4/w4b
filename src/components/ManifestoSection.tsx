    ...
    <div id="manifesto" className="max-w-3xl mx-auto px-6">
      ...
      <Section id="new-economy" title="The New Economy">
        ...
        <p>
          ...
          can transact thousands of times per day. The <strong>$BNBAUTO</strong> token fuels this ecosystem —
      ...
      <Section id="roadmap" title="Roadmap">
        <div className="space-y-8">
          {[
            ...
            { phase: "Phase 3", title: "Replication", desc: "Agent self-replication. $BNBAUTO token fair launch. Community testnet challenges." },
